...
export const TechText: React.FC<TechTextProps> = ({
  ...
  useEffect(() => {
    ...
    const falloff = (target: CanvasRenderingContext2D, cx: number, cy: number, radius: number, strength: number, softnessVal: number) => {
    ...
    const locate = (e: MouseEvent | PointerEvent) => {
